...
function breakthrough_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'breakthrough-fonts', '//fonts.googleapis.com/css?family=Alegreya+Sans:400,400i,700|PT+Serif:400,400i,700,700i', [], CHILD_THEME_VERSION );
	wp_enqueue_style( 'ionicons', '//code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css', [], CHILD_THEME_VERSION );

	$suffix = ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) ? '' : '.min';
	wp_enqueue_script( 'breakthrough-responsive-menu', CHILD_URL . '/js/responsive-menus' . $suffix . '.js', [ 'jquery' ], CHILD_THEME_VERSION, true );
	wp_localize_script(
